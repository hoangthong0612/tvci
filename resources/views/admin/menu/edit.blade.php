...
@section('content')
    ...
    @endif
    <form action="{{ route('admin.menu.update', $menu->id) }}" class="row" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="col-6">
            ...
            <div class="form-group">
                ...
                <input type="text" required class="form-control" id="path" name="path"
            ...
            <div class="form-group">
                ...
                <select name="parent_id" class="form-control">
                    ...
                    {!! MenuHelper::renderMenuOptions($menus, '', old('parent_id', $menu->parent_id)) !!}
                </select>
            </div>
