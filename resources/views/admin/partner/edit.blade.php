...
@section('content')
    ...
    @endif
    <form action="{{ route('admin.partners.update', $partner->id) }}" class="p-5 bg-white" method="POST"
                        ...
                        <div class="thumb">
                            <div class="avatar-preview">
                                <div class="profilePicPreview"
                                    style="background-image: url('{{ $partner->image ? '/' . imagePath()['partners']['path'] . '/' . $partner->image : getImage($partner->image) }}')"">
                                </div>
                            </div>
